...
bool isHalfPalindrome(int a){
    //This function counts the parity of digits in the number a
    //If we have more than one odd numbered digit than the number cannot be a half palindrome
    //Also to exclude numbers like "100" which end up with zeroes on each end we check wheteher there is
    //at least one other even numbered digit.
    ...
    for(size_t i {0}; i <= 9; i++){
        ...
        else if(digitCount % 2 == 0 && i != 0 && digitCount != 0)
